...
if( $User->InGroup($_params['access']) ){
	...
	$db_element = mysqli_query($db, "SELECT * FROM `ws_categories` WHERE id='".$Elem['section_id']."'");
        ...
        <div class="content-wrapper">
			<section class="content-header">
				<div class="btn-group backbutton">
					<a class="btn btn-block btn-info btn-xs" href="list_elem.php?section_id=<?=$_GET['cat_id']?>"><?=$GLOBALS['CPLANG']['GO_BACK']?> (<?=$_params['title']?>)</a>
				</div>
							...
							<div class="nav-tabs-custom">
								...
								<div class="tab-content form-horizontal">
									...
									<div class="tab-pane active" id="tab_1">
                                        ...
                                        <input name="section_id" value="<?=$Elem['section_id']?>" hidden >
                                        <div class="form-group">
                                        ...
                                        ?>
                                        <input name="col_list" value="<?=$tot_col?>" hidden >
                                        <div class="form-group">
