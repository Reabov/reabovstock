							...
							<div class="nav-tabs-custom">
								...
								<div class="tab-content form-horizontal">
									...
									<div class="tab-pane active" id="tab_1">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3"> Категория <b class="red">*</b> </label>
                                            <div class="col-sm-2">
                                                <select required name="section_id" class="form-control input-sm">
                                                    <?
                                                    $get = mysqli_query($db, " SELECT * FROM ws_catalog ");
                                                    while($langSite = mysqli_fetch_assoc($get)){
                                                        $sel = '';
                                                        if( $Elem['section_id'] == $langSite['id'] ) { $sel = ' selected '; }
                                                        ?>
                                                        <option <?=$sel?> value="<?=$langSite['id']?>">
                                                            <?=$langSite['title_'.$Admin->lang]?>
                                                        </option>
                                                        <?
                                                    }
                                                    ?>
                                    ...
                                    <div class="tab-pane" id="tab_10">
                                        ...
                                        $getParamGall = $Db->getone(" SELECT * FROM `ws_photogallery_params` WHERE page_id = '". $_params['page_id'] ."' ");
                                        if( $_params['page_id'] == 0 || !$getParamGall ) {
                                            ?>
                                            *Не заданы настройки для галлереи
                                            <?
                                        } else {
                                            /*галерея*/
