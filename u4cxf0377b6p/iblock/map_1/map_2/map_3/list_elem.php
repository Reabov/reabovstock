                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-header">
                            ...
                            $query = "SELECT id FROM `".$_params['table']."` WHERE section_id = '". $_GET['section_id'] ."' ";
                            ...
                            $query = " SELECT id FROM `".$_params['table']."` WHERE section_id = '". $_GET['section_id'] ."' $fieldToSearch ";
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover table-striped dataTable">
                                ...
                                WHERE section_id = '". $_GET['section_id'] ."'  $fieldToSearch 
                                ...
                                while ( $Elem = mysqli_fetch_assoc($subcatalog) ){
                                    ...
                                    <tr class="<?if($Elem['active']==0){?>disabled<?}?>">
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                <?=trim_text( $Elem['preview_'.$Admin->lang], 150 ) ?>
                                            </div>
                                        </td>
