	...
	include($_SERVER["DOCUMENT_ROOT"]."/". WS_PANEL ."/templates/lte/left_menu.php");
        ...
        <div class="content-wrapper">
			<section class="content-header">
                ...
                <div class="btn-group wgroup pull-right size13">
                    <a target="_blank" class="btn btn-default btn-xs size14" href="/<?=WS_PANEL?>/iblock/documents/?page_id=<?=$_params['page_id']?>&elem_id=<?=$id?>"> <i class="fa fa-cloud-upload"></i> Документы </a> &nbsp;
                </div>
                <div class="both"></div>
				...
				<div>
				    ...
				    if( isset( $_POST['ok'] ) ){
						...
						$main_page = checkboxParam('main_page');
							...
							<div class="nav-tabs-custom">
								...
								<div class="tab-content form-horizontal">
									...
									<div class="tab-pane active" id="tab_1">
					                    ...
					                    <? editElem('email',  $GLOBALS['CPLANG']['EMAIL'], '1', $Elem,  '', 'edit', 1, 4,'','','' ); ?>
                                        <? editElem('phone',  'Номер телефона', '1', $Elem,  '', 'edit', 1, 4,'','','' ); ?>
					                ...
					                foreach( $Admin->ar_lang as $lang_index ){  ?>
					                    ...
					                    <div class="tab-pane" id="tab_<?=$c_tab++?>">
                                            ...
                                            <? editElem('function', 'Должность', '1', $Elem,  $lang_index, 'edit', 1, 7 ); ?>
					                    </div>
