						...
						<div class="box">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover table-striped dataTable">
									<tr>
										<th width="30">ID</th>
										<th style="text-align:center;"><?=$GLOBALS['CPLANG']['EMAIL']?></th>
								        <th style="text-align:center;"><?=$GLOBALS['CPLANG']['TITLE']?></th> 
								        <th style="text-align:center;"><?=$GLOBALS['CPLANG']['IMAGE']?></th>          
								        ...
								        <tr class="<?if($Elem['active']==0){?>disabled<?}?>">
								            ...
								            <td align="center" width="210">
												<div class="btn-group wgroup">
							                		...
							                		<a onclick="return confirm('<?=$GLOBALS['ar_define_langterms']['MSG_ADM_SURE_TO_DELETE']?>')" href="delete_elem.php?id=<?=$Elem['id']?>" class="btn btn-default btn-danger" title="<?=$GLOBALS['ar_define_langterms']['MSG_ADM_EDIT']?>">
