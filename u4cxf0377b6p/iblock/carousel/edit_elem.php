			...
			<section class="content-header">
				...
				<div>
				    ...
				    if( isset( $_POST['ok'] ) ){
				        ...
				        updateElement($id, $_params['table'],array('green' => $green));
							...
							<div class="nav-tabs-custom">
								...
								<div class="tab-content form-horizontal">
									...
									<div class="tab-pane active" id="tab_1">
										<? editElem('green', 'Green', '3', $Elem, '', 'edit' ); ?>
										<?
                                        foreach( $Admin->ar_lang as $lang_index ){  
                                            editElem('text', $GLOBALS['CPLANG']['TITLE']." (".$lang_index.")", '1', $Elem,  $lang_index, 'edit', 1, 7 );
                                        }?>
                                        <? editElem('year','Год', '1', $Elem,  '', 'edit', 1, 2 ); ?>									
