        ...
        <div class="method__wrapper">
            <a onclick="close_modal_prices()" class="method__close pay__close">
                <img src="/images/icons/pay_close.svg" alt="">
            </a>
            ...
            <div class="method__select">
                ...
                <button class="accept accept-method"onclick="setO(this)">
                    <span class="a circle_checkbox">
                    	<span class="s circle" data-value="pay" ></span>
                    </span>
                    <?=$GLOBALS['ar_define_langterms']['MSG_SUBSCRIBES_PAYPAL']?>
                </button>
            </div>
            ...
            <div class="method__accept">
                <button class="accept" onclick="setAll1(this)">
                    <span class="ac ac1 circle_checkbox">
                    	<span id="accept_terms" class="s circle"></span>
                    </span>
                    <?=$GLOBALS['ar_define_langterms']['MSG_SUBSCRIBES_I_ACCEPT_ALL']?> 
                    <a href="<?=$CCpu->writelink(72)?>" target="_blank" class="underline"><?=$GLOBALS['ar_define_langterms']['MSG_SUBSCRIBES_TERMS_AND_CONDITION']?></a>
                </button>
                <button class="accept method-accept-btn2" onclick="setAll2(this)">
                    <span class="ac ac2 circle_checkbox">
                    	<span id="accept_policy" class="s circle"></span>
                    </span>
                    <?=$GLOBALS['ar_define_langterms']['MSG_SUBSCRIBES_I_ACCEPT']?> 
                    <a href="<?=$CCpu->writelink(85)?>" target="_blank" class="underline"><?=$GLOBALS['ar_define_langterms']['MSG_SUBSCRIBES_PRIVACY_POLICY']?></a>
                </button>
            </div>
            ...
            <div class="method_logo-pay">
                ...
                <div class="method_logo-item">
                    <img src="/images/other/pay-grey/pay_american.svg" alt="">
                </div>
            </div>
