...
class AcImage
{
    ...
    const BOTTOM_LEFT = 3;
    const TOP_CENTER = 4; // webmaster 2021.07.12
    const BOTTOM_CENTER = 5; // webmaster 2021.07.12
    const CENTER = 6; // webmaster 2021.07.12

    private static $correctCorners = array (0, 1, 2, 3, 4, 5, 6); // webmaster 2021.07.12
    ...
    private function getLogoPosition($corner, $width, $height)
    {
        ...
        if ($corner == self::BOTTOM_CENTER || $corner == self::TOP_CENTER) // webmaster 2019.03.15
            $x = $this->getWidth()/2 - $paddingX - $width/2;

        if ( $corner == self::CENTER ) { // webmaster 2019.03.15
