...
require_once($_SERVER['DOCUMENT_ROOT'].'/'.WS_PANEL.'/include.php');

//if(!empty($_GET['t'])) {
	
	if($_GET['t'] == 'm') {
		
		$type = 'upload/test_thumb';
		
	//	$width_list = array(25,872,185, 50);
		//$height_list = array(25,185 ,872, 50);
...
//$_GET['src'] = $_SERVER['DOCUMENT_ROOT'].'/'.$type.'/'.$_GET['src']; 
